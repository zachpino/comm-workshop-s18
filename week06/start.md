...
Fortunately, that's a pretty effective plot! We can begin to see patterns in the data without adding more complexity. But, it has a number of limitations.

- It's impossible to see which congressional district corresponds to each dot.
- We're wasting a potential dimension! The circles are all the same size.
